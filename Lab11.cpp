...
int main()
{
    ...
    while (testPlayer.getNumCards() > 0)
    {
        ...
        if (dropCards.size() == 0)
        {
            cout << endl << "\nNot enough cards to drop, player now has " << testPlayer.getNumCards() << " cards in hand!" << endl;
        }
        else
        {
            cout << endl << "\nAfter dropping THREE cards, player now has " << testPlayer.getNumCards() << " cards in hand!" << endl;
        }
